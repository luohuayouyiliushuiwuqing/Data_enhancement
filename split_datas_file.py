...
label_folder_name = "YOLOLabels"

base_path = "/media/igs/Dataset/Data_enhancement/OriginalData/Urban-Surv-HV-UAV/Aviation-HV-UAV"
img_path = os.path.join(base_path, img_folder_name)
label_path = os.path.join(base_path, label_folder_name)

output_base_path = "/media/igs/Dataset/Data_enhancement/OriginalData/Urban-Surv-HV-UAV/Aviation-HV-UAV_Split"
